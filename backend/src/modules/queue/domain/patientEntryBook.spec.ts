...
test('create custom patient entry book', () => {
    customPatientEntryBookResult = PatientEntryBook.create({ patientList: [], patientStats });
...
test('create patient with default status', () => {
    onlinePatientResult = Patient.create({ status: patientDefaultStatus, waitingNumber: Infinity });
