...
const patientWithCustomStatusResult = Patient.create({ status: paitentCustomStatusResult.getValue() });
const patientWithDefaultStatusResult = Patient.create({ status: paitentDefaultStatusResult.getValue() });
const patientWithJoinedStatusResult = Patient.create({ status: paitentJoinedStatusResult.getValue() });
const patientWithLeavedStatusResult = Patient.create({ status: paitentLeavedStatusResult.getValue() });
